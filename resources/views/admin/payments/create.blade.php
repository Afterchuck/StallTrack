<x-layouts.admin title="Record payment" active="payments">
    <div class="form-back">
    ...
    <div class="page-heading vendor-form-heading">
        <div>
            ...
            <p>
                Record a collection and issue a receipt for a vendor.
            </p>
        </div>
    </div>
    ...
    <section class="form-panel payment-form-panel">
        <form method="POST" action="{{ route('payments.store') }}" class="portal-form">
            @csrf
